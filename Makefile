...
## Build
all: $(TARGET) avrdice.hex avrdice.eep avrdice.lss size
...
.PHONY: clean
clean:
	-rm -rf $(OBJECTS) avrdice.elf dep/* avrdice.o.d avrdice.hex avrdice.eep avrdice.lss avrdice.map
